...
Gb("<!DOCTYPE html>",0);var Ib=Gb("",0);Gb("<br>",0);function Jb(a,b){var c=b instanceof H?b:yb(b);a.href=wb(c)}
...
function b(r){for(var u=h,p=0;64>p;p+=4)u[p/4]=r[p]<<24|r[p+1]<<16|r[p+2]<<8|r[p+3];for(p=16;80>p;p++)r=u[p-3]^u[p-8]^u[p-14]^u[p-16],u[p]=(r<<1|r>>>31)&4294967295;r=e[0];var C=e[1],K=e[2],qa=e[3],uc=e[4];for(p=0;80>p;p++){if(40>p)if(20>p){var Ka=qa^C&(K^qa);var Hb=1518500249}else Ka=C^K^qa,Hb=1859775393;else 60>p?(Ka=C&K|qa&(C|K),Hb=2400959708):(Ka=C^K^qa,Hb=3395469782);Ka=((r<<5|r>>>27)&4294967295)+Ka+uc+Hb+u[p]&4294967295;uc=qa;qa=K;K=(C<<30|C>>>2)&4294967295;C=r;r=Ka}e[0]=e[0]+r&4294967295;e[1]=
...
;function zc(a,b,c){var d=[],e=[];if(1==(Aa(c)?2:1))return e=[b,a],G(d,function(g){e.push(g)}),Ac(e.join(" "));
...
a=Ac(e.join(" "));a=[c,a];0==h.length||a.push(h.join(""));return a.join("_")}
function Ac(a){var b=yc();b.update(a);return b.ta().toLowerCase()}
;function Bc(a){var b=xc(String(v.location.href)),c=v.__OVERRIDE_SID;null==c&&(c=(new Ub(document)).get("SID"));if(c&&(b=(c=0==b.indexOf("https:")||0==b.indexOf("chrome-extension:"))?v.__SAPISID:v.__APISID,null==b&&(b=(new Ub(document)).get(c?"SAPISID":"APISID")),b)){c=c?"SAPISIDHASH":"APISIDHASH";var d=String(v.location.href);return d&&b&&c?[c,zc(xc(d),b,a||null)].join(" "):null}return null}
...
var Fc;
function Gc(){var a=v.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&-1==Ab.indexOf("Presto")&&(a=function(){var e=document.createElement("IFRAME");e.style.display="none";Kb(e);document.documentElement.appendChild(e);var f=e.contentWindow;e=f.document;e.open();e.write(Fb(Ib));e.close();var h="callImmediate"+Math.random(),g="file:"==f.location.protocol?"*":f.location.protocol+"//"+f.location.host;e=A(function(k){if(("*"==g||k.origin==g)&&
...
!Ca(v.setImmediate)||v.Window&&v.Window.prototype&&-1==Ab.indexOf("Edge")&&v.Window.prototype.setImmediate==v.setImmediate?(Fc||(Fc=Gc()),Fc(b)):v.setImmediate(b)}}
...
function wd(a,b){if(0==a.f)if(a.h){var c=a.h;if(c.g){for(var d=0,e=null,f=null,h=c.g;h&&(h.h||(d++,h.f==a&&(e=h),!(e&&1<d)));h=h.next)e||(f=h);e&&(0==c.f&&1==d?wd(c,b):(f?(d=f,d.next==c.i&&(c.i=d),d.next=d.next.next):xd(c),yd(c,e,3,b)))}a.h=null}else od(a,3,b)}
function zd(a,b){a.g||2!=a.f&&3!=a.f||Ad(a);a.i?a.i.next=b:a.g=b;a.i=b}
function td(a,b,c,d){var e=rd(null,null,null);e.f=new M(function(f,h){e.g=b?function(g){try{var k=b.call(d,g);f(k)}catch(l){h(l)}}:f;
e.onRejected=c?function(g){try{var k=c.call(d,g);!w(k)&&g instanceof vd?h(g):f(k)}catch(l){h(l)}}:h});
e.f.h=a;zd(a,e);return e.f}
M.prototype.A=function(a){this.f=0;od(this,2,a)};
M.prototype.B=function(a){this.f=0;od(this,3,a)};
function od(a,b,c){if(0==a.f){a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.f=1;a:{var d=c,e=a.A,f=a.B;if(d instanceof M){zd(d,rd(e||xa,f||null,a));var h=!0}else if(nd(d))d.then(e,f,a),h=!0;else{if(Da(d))try{var g=d.then;if(Ca(g)){Bd(d,g,e,f,a);h=!0;break a}}catch(k){f.call(a,k);h=!0;break a}h=!1}}h||(a.w=c,a.f=b,a.h=null,Ad(a),3!=b||c instanceof vd||Cd(a,c))}}
function Bd(a,b,c,d,e){function f(k){g||(g=!0,d.call(e,k))}
...
;function ge(a){var b=[];Ua(a,function(c,d){var e=encodeURIComponent(String(d)),f;Aa(c)?f=c:f=[c];G(f,function(h){""==h?b.push(e):b.push(e+"="+encodeURIComponent(String(h)))})});
return b.join("&")}
...
v.document.createElementNS&&l.set(0);c=tc();c["allow-top-navigation-by-user-activation"]&&l.set(1);c["allow-popups-to-escape-sandbox"]&&l.set(2);v.crypto&&v.crypto.subtle&&l.set(3);v.TextDecoder&&v.TextEncoder&&l.set(4);l=Xd(l);n.bc=l;n.bih=k.height;n.biw=k.width;n.brdim=b.join();a=a.g;return n.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[a.visibilityState||a.webkitVisibilityState||a.mozVisibilityState||""]||0,n.wgl=!!E.WebGLRenderingContext,n}
var le=new function(){var a=window.document;this.f=window;this.g=a};
y("yt.ads_.signals_.getAdSignalsString",function(a){return ge(ke(a))},void 0);B();function oe(a,b){var c=S(a);return void 0===c&&void 0!==b?b:Number(c||0)}
...
function xe(a){var b=window.location.search,c=I(J(3,a)),d=I(J(5,a));d=(c=c&&c.endsWith("youtube.com"))&&d&&d.startsWith("/api/");if(!c||d)return a;var e=he(b),f={};G(te,function(h){e[h]&&(f[h]=e[h])});
return je(a,f||{},!1)}
function we(a,b){var c=Q("CORS_HEADER_WHITELIST")||{},d=I(J(3,a));return d?(c=c[d])?0<=La(c,b):!1:!0}
...
return h}
function ze(a,b){b.ya&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=Q("XSRF_FIELD_NAME",void 0),d=b.Ya;d&&(d[c]&&delete d[c],a=ie(a,d));return a}
function Ae(a,b){var c=Q("XSRF_FIELD_NAME",void 0),d=Q("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.F,h=$d("XSRF_FIELD_NAME"),g;b.headers&&(g=b.headers["Content-Type"]);b.rb||I(J(3,a))&&!b.withCredentials&&I(J(3,a))!=document.location.hostname||"POST"!=b.method||g&&"application/x-www-form-urlencoded"!=g||b.F&&b.F[h]||(f||(f={}),f[c]=d);f&&x(e)&&(e=he(e),db(e,f),e=b.la&&"JSON"==b.la?JSON.stringify(e):lc(e));f=e||f&&!Ya(f);!ue&&f&&"POST"!=b.method&&(ue=!0,R(Error("AJAX request with postData should use POST")));
return e}
...
'+"\\"></body>"',style:"display:none"}),(9==a.nodeType?a:a.ownerDocument||a.document).body.appendChild(a))):e?Ce(a,b,"POST",e,d):Q("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)||d?Ce(a,b,"GET","",d):((d=Zd.EXPERIMENT_FLAGS)&&d.web_use_beacon_api_for_ad_click_server_pings&&-1!=I(J(5,a)).indexOf("/aclk")&&"1"===oc(a,"ae")&&"1"===oc(a,"act")?Le(a)?(b&&b(),d=!0):d=!1:d=!1,d||Me(a,b)))}
...
;function ug(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||Q("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.mb||Q("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().lb:b=Bc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=Q("SESSION_INDEX",0),S("pageid_as_header_web")&&(d["X-Goog-PageId"]=Q("DELEGATED_SESSION_ID")));return d}
function vg(a){a=Object.assign({},a);delete a.Authorization;var b=Bc();if(b){var c=new Rc;c.update(Q("INNERTUBE_API_KEY",void 0));c.update(b);b=c.digest();Ba(b);if(!Sb)for(Sb={},Tb={},c=0;65>c;c++)Sb[c]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(c),Tb[c]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_.".charAt(c);c=Tb;for(var d=[],e=0;e<b.length;e+=3){var f=b[e],h=e+1<b.length,g=h?b[e+1]:0,k=e+2<b.length,l=k?b[e+2]:0,n=f>>2;f=(f&3)<<4|g>>4;g=(g&15)<<
...
timeout:d.timeout,withCredentials:!0},f="",h=a.f.Ha;h&&(f=h);h=a.f.Ia||!1;var g=ug(h,f,d);Object.assign(e.headers,g);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var k=ie(""+f+("/youtubei/"+a.f.Ba+"/"+b),{alt:"json",key:a.f.Aa}),l;if(d.retry&&S("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(l=zg(b,c,g,h))){var n=e.onSuccess,r=e.ja;e.onSuccess=function(u,p){Ag(l);n(u,p)};
...
y("yt_logging_screen.setCurrentScreen",Kg,void 0);function Lg(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=Q("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=Q("VALID_SESSION_TEMPDATA_DOMAINS",[]),h=I(J(3,window.location.href));h&&f.push(h);h=I(J(3,d));if(0<=La(f,h)||!h&&0==d.lastIndexOf("/",0))if(S("autoescape_tempdata_url")&&(f=document.createElement("a"),Jb(f,d),d=f.href),d){h=d.match(jc);d=h[5];f=h[6];h=h[7];var g="";d&&(g+=d);f&&(g+="?"+f);h&&(g+="#"+h);d=g;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&(b.itct||b.ved)&&
...
t(Ng,L);Ng.prototype.m=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.ob)}L.prototype.m.call(this)};var Og=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Pg(a){a=a||"";if(window.spf){var b=a.match(Og);spf.style.load(a,b?b[1]:"",void 0)}else Qg(a)}
...
m.m=function(){ah(this);if(this.j&&this.f&&this.j.destroy)try{this.j.destroy()}catch(b){R(b)}this.V=null;for(var a in this.i)v[this.i[a]]=null;this.Z=this.f=this.api=null;delete this.U;delete this.l;L.prototype.m.call(this)};
function bh(a){return a.f&&a.f.args&&a.f.args.fflags?-1!=a.f.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;var fh={},gh="player_uid_"+(1E9*Math.random()>>>0);function hh(a){var b="player";b=x(b)?ac(b):b;var c=gh+"_"+(b[Ea]||(b[Ea]=++Fa)),d=fh[c];if(d)return d.loadNewVideoConfig(a),d.api;d=new Tg(b,c);fh[c]=d;cf("player-added",d.api);Tc(d,Ia(ih,d));T(function(){d.loadNewVideoConfig(a)},0);
return d.api}
...
di.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=hd(a);c.postMessage(d,this.A)}catch(e){R(e,"WARNING")}}};
di.prototype.m=function(){window.removeEventListener("message",this.o);L.prototype.m.call(this)};function ei(a,b,c){di.call(this,a,b,c||Q("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.l=this.f=this.j=null}
...
function xi(a,b){T(function(){ud(mi().then(vi,function(c){return wi(b,c)}),xa)},a)}
function yi(){try{var a=z("yt.ads.biscotti.getId_");return a?a():ce()}catch(b){return sd(b)}}
;function zi(a){if("1"!==Va(ae(),"args","privembed")){a&&be();try{yi().then(function(b){S("pass_biscotti_id_in_header_ajax_tv")||S("pass_biscotti_id_in_header_ajax")||(b=ke(b),b.bsq=Ai++,He("//www.youtube.com/ad_data_204",{ya:!1,F:b,withCredentials:!0}))},function(){}),T(zi,18E5)}catch(b){R(b)}}}
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&Af.dispose();a=0;for(var b=uf.length;a<b;a++)tf(uf[a]);uf.length=0;nf("//static.doubleclick.net/instream/ad_status.js");vf=!1;P("DCLKSTAT",0);Vc(Hi,Gi);if(a=Fi)a.removeEventListener("onScreenChanged",Ki),a.removeEventListener("onLogClientVeCreated",Ji),a.removeEventListener("onLogServerVeCreated",Li),a.removeEventListener("onLogVeClicked",Mi),a.removeEventListener("onLogVesShown",Ni),a.destroy();Ii={}});
